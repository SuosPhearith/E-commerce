    ...
    <nav class="sidebar">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <RouterLink to="/backend/product" class="nav-link">
              <i class="link-icon" data-feather="box"></i>
              <span class="link-title">Product</span>
            </RouterLink>
          </li>
          <li class="nav-item">
            <RouterLink to="/backend/category" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <RouterLink to="/backend/product/products" class="nav-link"
                    >Products</RouterLink
                  >
                </li>
                <li class="nav-item">
                  <RouterLink to="/backend/product/categories" class="nav-link"
